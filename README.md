...
```
Session  Agent Pattern          Tools  Core Addition              Key Insight
-------  --------------------  -----  -------------------------  ----------------------------
...
| Agent Pattern       | Session | What It Does                                    |
|---------------------|---------|-------------------------------------------------|
...
Available in English, Chinese, and Japanese under `docs/{en,zh,ja}/`.

- [s01: The Agent Loop](./docs/en/s01-the-agent-loop.md)
- [s02: Tools](./docs/en/s02-tool-use.md)
- [s03: TodoWrite](./docs/en/s03-todo-write.md)
- [s04: Subagents](./docs/en/s04-subagent.md)
- [s05: Skills](./docs/en/s05-skill-loading.md)
- [s06: Compact](./docs/en/s06-context-compact.md)
- [s07: Tasks](./docs/en/s07-task-system.md)
